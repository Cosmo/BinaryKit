...
final class BinaryKitTests: XCTestCase {
    ...
    func testWrite() {
        ...
        bin.writeBit(bit: 1)
        XCTAssertEqual(bin.dataStore, Data([128]))
        bin.writeBit(bit: 1)
        XCTAssertEqual(bin.dataStore, Data([192]))
        bin.writeBit(bit: 1)
        XCTAssertEqual(bin.dataStore, Data([224]))
        bin.writeBit(bit: 1)
        XCTAssertEqual(bin.dataStore, Data([240]))
        bin.writeBit(bit: 1)
        XCTAssertEqual(bin.dataStore, Data([248]))
        bin.writeBit(bit: 1)
        XCTAssertEqual(bin.dataStore, Data([252]))
        bin.writeBit(bit: 1)
        XCTAssertEqual(bin.dataStore, Data([254]))
        bin.writeBit(bit: 1)
        XCTAssertEqual(bin.dataStore, Data([255]))
        bin.writeBit(bit: 1)
        XCTAssertEqual(bin.dataStore, Data([255, 128]))
        bin.writeByte(7)
        XCTAssertEqual(bin.dataStore, Data([255, 128, 7]))
        bin.writeByte(128)
        XCTAssertEqual(bin.dataStore, Data([255, 128, 7, 128]))
        bin.writeString("hello world!")
        XCTAssertEqual(bin.dataStore, Data([255, 128, 7, 128] + [UInt8]("hello world!".utf8)))
